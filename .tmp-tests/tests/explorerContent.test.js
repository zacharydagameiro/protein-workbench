...
import { buildRecentItems, getTeachingCodonEntry, normalizeDisplayTitle, } from '../src/utils/explorerContent.js';
...
test('normalizeDisplayTitle converts shouty source titles to readable text', () => {
    const normalized = normalizeDisplayTitle('WATER STRUCTURE OF A HYDROPHOBIC PROTEIN AT ATOMIC RESOLUTION');
