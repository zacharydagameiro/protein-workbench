...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (_jsx("tr", { ref: ref, className: cn('border-b border-border/55 transition-colors hover:bg-secondary/20', className), ...props })));
